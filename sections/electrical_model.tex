...
is negligible.
Second, due to the voltage loss along the traces, a slightly lower voltage is supplied to modules on one end of the substructure (farthest from the EOS card).
