\textit{From Graham: I think there is too much detail here (although it is doubtless accurate). Could the text be simplified, given that information is availablein figure 4?}
