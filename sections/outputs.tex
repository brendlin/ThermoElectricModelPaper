...
\begin{figure}[ht]
\centering
\subfloat[] {\label{fig:rampoptimization_a} \includegraphics[width=0.45\linewidth]{figures/ModulePower_R1_newramp.eps}}
\subfloat[] {\label{fig:rampoptimization_b} \includegraphics[width=0.45\linewidth]{figures/SensorCurrent_R1_newramp.eps}}\quad\quad
