...
The temperature of the FEAST was measured with an NTC thermistor and a PTAT sensor residing on the FEAST
...
The TID bump is an important source of uncertainty in our model. The experimental data exhibits
