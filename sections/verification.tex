...
% which is caused by heat flux from the end-of-structure card and degraded thermal impedance at the end of the stave due to ceramic sections in the cooling pipe,
...
\begin{figure}[ht]
\centering
\subfloat[] {\label{fig:verification_a} \includegraphics[width=0.11\linewidth]{figures/replacement.pdf}}\quad\quad
\subfloat[] {\label{fig:verification_b} \includegraphics[width=0.275\linewidth]{figures/verificationFEA.pdf}}\quad\quad
\subfloat[] {\label{fig:verification_c} \includegraphics[width=0.44\linewidth]{figures/verification.pdf}}
