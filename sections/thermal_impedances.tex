...
\begin{figure}[ht]
\centering
\subfloat[Barrel short strip module] {\includegraphics[width=0.49\linewidth]{figures/ThermalImpedanceFit_ShortStripEOS_Rcm.eps}}
\subfloat[Endcap R0 module] {\includegraphics[width=0.49\linewidth]{figures/ThermalImpedanceFit_R0_Rcm.eps}}
...
% Endcap: 
% Endcap: Rcm ranges from 0.6 C/W (R5) to 1.4 C/W (R2). Other nodes have between 10-30 C/W.
