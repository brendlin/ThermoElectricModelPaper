...
\author[1]{Georg Viehhauser} %\ead[url]{www.stmdocs.in}
\author[2]{Graham Beck}      %\ead[url]{www.stmdocs.in}
\author[3]{Kurt Brendlinger} %\ead{cvr@sayahna.org}
\author[3]{Yu-Heng Chen}     %\ead[url]{www.stmdocs.in}
